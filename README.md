About certbot-dns-rfc2136-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/certbot-dns-rfc2136-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/certbot-dns-rfc2136-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add certbot-dns-rfc2136
# for installing globally
pixi global install certbot-dns-rfc2136
```
...
It is possible to list all of the versions of `certbot-dns-rfc2136` available on your platform:
...
```
pixi search certbot-dns-rfc2136 --channel conda-forge
```
